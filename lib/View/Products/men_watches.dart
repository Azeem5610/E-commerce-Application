...
class MenWatchesPage extends StatefulWidget {
  const MenWatchesPage({super.key});

  @override
  State<MenWatchesPage> createState() => _MenWatchesPageState();
}

class _MenWatchesPageState extends State<MenWatchesPage> {
   Future<GetMenWatchesModel> apiServices=ECommerceApiServices().getMenWatch();
   @override
  void initState() {
    apiServices;
    super.initState();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: "Men-Watches"),
        body: FutureBuilder<GetMenWatchesModel>(

        future:apiServices,
        builder: (context,AsyncSnapshot<GetMenWatchesModel> snapshot) {
          if(!snapshot.hasData){ 
