...
class _SmartphonesPageState extends State<SmartphonesPage> {
   Future<GetSmartphonesModel> apiServices=ECommerceApiServices().getSmartPhones();
   @override
  void initState() {
    apiServices;
    super.initState();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: "SmartPhones"),
        body: FutureBuilder<GetSmartphonesModel>(

        future:apiServices,
        builder: (context,AsyncSnapshot<GetSmartphonesModel> snapshot) {
          if(!snapshot.hasData){ 
