...
class WomensShoesPage extends StatefulWidget {
  const WomensShoesPage({super.key});

  @override
  State<WomensShoesPage> createState() => _WomensShoesPageState();
}

class _WomensShoesPageState extends State<WomensShoesPage> {
   Future<GetWomanShoesModel> apiServices=ECommerceApiServices().getWomenShoes();
   @override
  void initState() {
    apiServices;
    super.initState();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:CustomAppBar(title: "Women Shoes"),
        body: FutureBuilder<GetWomanShoesModel>(

        future:apiServices,
        builder: (context,AsyncSnapshot<GetWomanShoesModel> snapshot) {
          if(!snapshot.hasData){ 
