class GetMobileAccessoriesModel {
  List<Products>? products;
  int? total;
  int? skip;
  int? limit;

  GetMobileAccessoriesModel({this.products, this.total, this.skip, this.limit});

  GetMobileAccessoriesModel.fromJson(Map<String, dynamic> json) {
