class GetWomanJewelleryModel {
  List<Products>? products;
  int? total;
  int? skip;
  int? limit;

  GetWomanJewelleryModel({this.products, this.total, this.skip, this.limit});

  GetWomanJewelleryModel.fromJson(Map<String, dynamic> json) {
